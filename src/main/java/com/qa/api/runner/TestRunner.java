...
/**
 * TestNG XML Runner for API Tests
 * Executes TestNG XML files from testrunners directory
 */
public class TestRunner {
     ...
     * @param xmlFileName - if provided, runs only that file; if null, runs all files
     */
