...
public class AmadeusAPITest extends BaseTest {
	...
	public void shouldValidatePriceObjectStructure() {
	    ...
	    List<Map<String, Object>> flights = res
	    									.jsonPath()
	    									.getList("data");
	...
	public void shouldValidateMaxPriceBoundary() {
	    Response res = makeFlightRequest(ORIGIN, "1");
	    List<Map<String, Object>> flights = res.jsonPath().getList("data");
	...
	private void validateFlightStructure(Map<String, Object> flight) {
		System.out.println("=== CONSOLE: validateFlightStructure called === "+ flight.toString());
	...
	/**
	 * low to high ticket range constraint set by customer 
	 * from $1 to $1000 to get the budget range set by endpoint
